//
//  RestorNavigationController.swift
//  Restor
//
...
class RestorNavigationController: UINavigationController {
    weak var navDelegate: RestorTableViewController?
    var shouldPopOnBackButton: (() -> Bool)?
